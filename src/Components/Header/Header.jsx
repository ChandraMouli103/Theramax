  ...
  const [activeNav, setActiveNav] = useState('Home')
    ...
    const services = [
      { label: 'Pelvic Floor PT', slug: 'pelvic-floor-pt' },
        ...
        { label: 'Carpal Tunnel Syndrome', slug: 'carpal-tunnel-syndrome' },
      { label: 'General Physical Therapy', slug: 'general-physical-therapy' },
        { label: 'Rehab Services', slug: 'rehab-services' },
      { label: 'Neurological Care', slug: 'neurological-care' },
      ...
      <div className={`header-nav ${menuOpen ? 'menu-open' : ''}`}>
        ...
        >
          <summary className='services-trigger'>
            <NavLink to='/services' className='nav-item' onClick={() => {

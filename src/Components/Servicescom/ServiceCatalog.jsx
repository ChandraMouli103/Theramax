...
export const serviceData = [
  ...
  makeService({ slug: 'gait-training', title: 'Gait Training', heading: 'Improve Walking, Balance, and Confidence with Gait Training', tag: 'Personalized support for safer, stronger walking.', description: 'Walking and balance rehabilitation for improved independence.', image: gaitImage, overview: 'Gait training helps improve walking patterns, balance, coordination, and confidence after injury, surgery, or neurological changes.', approachTitle: 'What is Gait Training?', approachText: 'Gait training uses targeted exercises and functional practice to improve posture, stepping, balance, and safe movement.', conditions: ['Walking difficulty', 'Balance problems', 'Fall risk', 'Post-surgical weakness', 'Neurological conditions'] }),
